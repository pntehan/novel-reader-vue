...
import BottomNav from '@/views/localReader/BottomNav';
import FontNav from '@/views/localReader/FontNav';
import ListPanel from '@/views/localReader/ListPanel';
...
export default {
  ...
  methods: {
    ...
    getData(id, chapter) {
      let data = JSON.parse(localStorage.getItem(id+"_"+chapter))
